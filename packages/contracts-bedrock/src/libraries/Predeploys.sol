...
library Predeploys {
    ...
    /// @notice Address of the SuperchainERC721TokenBridge predeploy.
    address internal constant SUPERCHAIN_ERC721_TOKEN_BRIDGE = 0x4200000000000000000000000000000000000029;
    ...
    function getName(address _addr) internal pure returns (string memory out_) {
        ...
        if (_addr == SUPERCHAIN_ERC721_TOKEN_BRIDGE) return "SuperchainERC721TokenBridge";
